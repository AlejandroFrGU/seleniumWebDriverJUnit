...
public class RegistroIncorrectoVacios {
  ...
  @Test
  public void testRegistroIncorrecto6() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='The Email field is required.'])[1]/following::li[1]")).click();
