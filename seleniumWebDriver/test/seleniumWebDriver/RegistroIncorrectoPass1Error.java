...
public class RegistroIncorrectoPass1Error {
  ...
  @Test
  public void testRegistroIncorrecto5() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("L5patata");
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("L5patata");
