...
public class ContrasenaIncorrectaPassNuevaMal3Errores {
  ...
  @Test
  public void testContrasenaIncorrecta3() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Change password'])[1]/following::ul[1]")).click();
