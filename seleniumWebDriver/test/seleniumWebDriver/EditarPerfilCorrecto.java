...
public class EditarPerfilCorrecto {
  ...
  public void testEditarPerfilCorrecto() throws Exception {
    ...
    driver.findElement(By.id("Input_PhoneNumber")).sendKeys("1");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Logout'])[1]/following::div[1]")).click();
    driver.findElement(By.id("update-profile-button")).click();
    driver.findElement(By.id("Input_Email")).click();
    driver.findElement(By.id("Input_Email")).clear();
    driver.findElement(By.id("Input_Email")).sendKeys("patata2@hotmail.com");
    driver.findElement(By.id("update-profile-button")).click();
    driver.findElement(By.id("Input_Email")).click();
    driver.findElement(By.id("Input_Email")).clear();
    driver.findElement(By.id("Input_Email")).sendKeys("patata@hotmail.com");
    driver.findElement(By.id("Input_PhoneNumber")).click();
    driver.findElement(By.id("Input_PhoneNumber")).clear();
    driver.findElement(By.id("Input_PhoneNumber")).sendKeys("2");
    driver.findElement(By.id("update-profile-button")).click();
